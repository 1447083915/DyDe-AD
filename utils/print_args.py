def print_args(args):
    ...
    if args.task_name == 'anomaly_detection':
        ...
        print(f'  {"Phy Loss W:":<20}{args.physics_loss_weight:<20}{"Phy Noise W:":<20}{args.physics_noise_loss_weight:<20}')
        print(f'  {"Phy Noise Std:":<20}{args.physics_noise_std:<20}')
        print(f'  {"Phy Order:":<20}{args.physics_order:<20}')
        print(f'  {"Profile Infer:":<20}{args.profile_inference:<20}{"Infer Warmup:":<20}{args.infer_warmup_steps:<20}')
        print(f'  {"Infer Repeat:":<20}{args.infer_repeat_steps:<20}')
        print()
